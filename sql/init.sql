...
CREATE INDEX IF NOT EXISTS idx_raw_shipments_loaded_at
    ON raw.shipments (shipment_id, loaded_at DESC);

CREATE INDEX IF NOT EXISTS idx_raw_tiers_customer
    ON raw.customer_tiers (customer_id, tier_updated_date DESC);
